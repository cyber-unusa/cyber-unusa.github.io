  ...
  return (
    <div class="min-h-screen flex flex-col justify-center items-center bg-secbg">
      <img
        src="/asset/com.jpg"
        alt="Logo"
        class="object-cover w-64 mb-8 rounded-full"
      />
      ...
      <div class="flex justify-center items-center space-x-4">
        <a
          href="/"
          class="bg-lowprim hover:shadow-lg hover:opacity-90 transition duration-300 ease-in-out text-white px-4 py-2 rounded-md"
        >
          Go Back
        </a>
      </div>
